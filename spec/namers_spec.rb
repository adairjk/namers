require_relative '../namers'
  ...
  RSpec.describe Namers do
    it 'should return a name in the correct order' do
      expect(Namers.parse_name('John Doe')).to eql 'Doe, John'
    end

    it 'should respect middle names' do
      expect(Namers.parse_name('John James Doe')).to eql 'Doe, John James'
    end

    it 'should respect middle initials' do
      expect(Namers.parse_name('John J Doe')).to eql 'Doe, John J'
    end
    ...
    it 'should respect and drop basic honorifics' do
      expect(Namers.parse_name('Dr. John J. Doe')).to eql 'Doe, John J.'
    end
